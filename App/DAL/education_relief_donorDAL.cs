...
namespace SPF.DAL
{
    internal class education_relief_donorDAL
    {
        ...
        public bool loginCheck(education_relief_donorBLL l)
        {
            ...
            try
            {
                ...
                string sql = "insert into education_relief_donor(cnic,firstname,lastname,email,password,phone) values(@cnic,@firstname,@lastname,@email,@password,@phone)" +
                    "insert into donor_data(cnic,firstname,lastname,email,password,phone) values(@cnic,@firstname,@lastname,@email,@password,@phone)";
