...
namespace SPF.DAL
{
    internal class repDAL
    {
        ...
        public bool loginCheck(repBLL l)
        {
            ...
            try
            {
                ...
                string sql = "insert into rep(cnic,firstname,lastname,email,password,phone,income,familymember,location) values(@cnic,@firstname,@lastname,@email,@password,@phone,@income,@familymember,@location)";
                ...
                cmd.Parameters.AddWithValue("@familymember", l.familymember);
                cmd.Parameters.AddWithValue("@income", l.income);
                cmd.Parameters.AddWithValue("@location", l.location);
