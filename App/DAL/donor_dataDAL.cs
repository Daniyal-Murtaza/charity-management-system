...
namespace SPF.DAL
{
    internal class donor_dataDAL
    {
        ...
        public bool loginCheck(donor_dataBLL l)
        {
            ...
            try
            {
                ...
                string sql = "insert into donor_data(cnic,firstname,lastname,email,password,phone) values(@cnic,@firstname,@lastname,@email,@password,@phone)";
        ...
        public DataTable Select()
        {
            ...
            try
            {
                ...
                string sql = "SELECT * FROM donor_data";
        ...
        public bool Update(donor_dataBLL d)
        {
            //Create a Boolean Variable and SEt its Default Value to FAlse
            bool isSuccess = false;
            ...
            try
            {
                ...
                string sql = "UPDATE donor_data SET firstName=@firstName, lastName=@lastName, email=@email, phone=@phone, cnic=@cnic, password=@password WHERE cnic=@cnic";
        ...
        public bool Delete(donor_dataBLL d)
        {
            //Create a Boolean variable and set its default value to false
            bool isSuccess = false;
            //Create SqlConnection To Connect DAtabase
            ...
            try
            {
                ...
                string sql = "DELETE FROM donor_data WHERE cnic=@cnic";
        ...
        public bool Insert(donor_dataBLL d)
        {
            //Create a Boolean Variable and SEt its default value to false
            bool isSuccess = false;
            ...
            try
            {
                ...
                string sql = "insert into transaction_dataa(cnic,programs,amount) values(@cnic,@programs,@amount)";
                //Create SQL Command to Execute the Query
                SqlCommand cmd = new SqlCommand(sql, con);
