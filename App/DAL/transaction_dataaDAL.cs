...
namespace SPF.DAL
{
    internal class transation_dataaDAL
    {
        ...
        public bool loginCheck(transaction_dataaBLL l)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@programs", l.programs);
        ...
        public DataTable Select()
        {
            ...
            try
            {
                ...
                string sql = "SELECT * FROM transaction_dataa";
