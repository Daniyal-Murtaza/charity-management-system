...
namespace SPF.DAL
{
    internal class flood_relief_volunteerDAL
    {
        ...
        public bool loginCheck(flood_relief_volunteerBLL l)
        {
            ...
            try
            {
                ...
                string sql = "insert into flood_relief_volunteer(cnic,firstname,lastname,email,password,phone) values(@cnic,@firstname,@lastname,@email,@password,@phone)" +
